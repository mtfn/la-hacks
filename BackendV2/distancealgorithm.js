function areCoordinatesWithinRadius(originalLat, originalLon, inputLat, inputLon, radiusMiles) {
    ...
    return {
        isWithinRadius: distance <= radiusMiles,
...
const inputLon = -117.446769;
const radiusMiles = 0.01;

const result = areCoordinatesWithinRadius(originalLat, originalLon, inputLat, inputLon, radiusMiles);

console.log(`Is within radius: ${result.isWithinRadius}, Distance: ${result.distanceMiles} miles`);
